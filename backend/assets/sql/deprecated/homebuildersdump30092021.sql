...
CREATE TABLE `project` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_project_customer1_idx` (`customer_username`),
  CONSTRAINT `fk_project_customer1` FOREIGN KEY (`customer_username`) REFERENCES `customer` (`username`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2021-09-30  9:18:43
