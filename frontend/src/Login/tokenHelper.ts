import {Session} from "../../../backend/lib/jwt/jwtInterfaces";
import {DecodeResult} from "../../../backend/lib/jwt/jwtHelpers";

export type TAlgorithm = 'HS256' | 'HS384' | 'HS512' | 'RS256';
export enum ExpirationStatus { "expired" , "active" , "grace"}
export const JWT_TOKEN="ClassicUserTokenForTestPurpose";
//
// export function checkExpirationStatus(tokenString: string): ExpirationStatus {
//     const now = Date.now();
//
//     decodeSession(JWT_TOKEN, tokenString)
//     if(token){
